...
unsigned int SubspaceJoinerSeq::joinWithEntries(SubspaceTable* subspaceTable, int ssTableSize) {
	...
	for (int i = 0; i < ssTableSize; i++)
	{
		...
		auto inserted = subspaceMap->insertEntryWithBool(ids, dimensions);
